 ...
 */
//
// Created by drmcfree on 23/03/2026.
//
...
enum
{
    ...
    // OS/Hardware Failures (-1 to -99)
    RP_ERR_MEMORY = -1,
    RP_ERR_IO = -2,

    // Kernel Core Logic (-100 to -999)
    RP_ERR_SYNC = -100,
    RP_ERR_PLUGIN_LOAD = -101,
    RP_ERR_MANDATE_FAIL = -102
};
#endif //RP_TYPES_H